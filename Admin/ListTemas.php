...
<html lang="pt-br">
  ...
  <body>
		...
		<?php include_once ('../menu.php');?>
            ...
            <caption><a class="btn btn-primary glyphicon glyphicon-plus" href="CadTema.php" role="button"> Cadastrar Novo</a></caption>
				<tr>
					<th>
						ID
					</th>
                ...
                <?php
					...
					foreach ($pods as $pod) {
                        ...
                        echo "<td> <form action='DeleteTema.php' method='post'>
							...
							echo "<td> <form action='UpdateTema.php' method='post'>
				             <input type='hidden' name='id' value=" .$pod['id'].">
